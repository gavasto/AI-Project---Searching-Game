...
to setup-point
  ...
  ;; setup ENDING POINT
   ask patches [
    ;; if patches are between (0,0) to (0,edge)...
    if pxcor = halfedge - 2 and pycor >= halfedge - 2 and pycor <= halfedge - 1
      [ set pcolor yellow ]                                 ;; ... draws left edge in yellow
    if pxcor = halfedge - 1 and pycor >= halfedge - 2 and pycor <= halfedge - 1
      [ set pcolor yellow ]                                 ;; ... draws left edge in yellow
...
to setup-point2
  ;; setup ENDING POINT
   ask patches [
    ;; if patches are between (0,0) to (0,edge)...
    if pxcor = 0 and pycor >= halfedge - 2 and pycor <= halfedge - 1
      [ set pcolor yellow ]                                 ;; ... draws left edge in yellow
    if pxcor = 1 and pycor >= halfedge - 2 and pycor <= halfedge - 1
      [ set pcolor yellow ]                                 ;; ... draws left edge in yellow
